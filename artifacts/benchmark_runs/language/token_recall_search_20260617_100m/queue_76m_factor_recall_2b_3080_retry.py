...
RUN_NAME = "factor_recall_3080_76m_2b_seed13_common3b_20260617_0318"
...
$code = $LASTEXITCODE
$ErrorActionPreference = 'Stop'
if ($code -ne 0) {{ throw "76M factor-recall trainer failed with exit code $code" }}
...
"""
    ...
    out = OUT_ROOT / "queued_76m_factor_recall_2b_3080_retry.json"
